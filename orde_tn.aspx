	...
	<head>
		...
		<script type="text/javascript">
			...
			var bbsNum = [
				...
				['txtMount', 10, 2, 1], ['txtTheory', 10, 3, 1], ['textSize1', 10, 3, 1],
				['textSize2', 10, 2, 1], ['textSize3', 10, 3, 1], ['textSize4', 10, 2, 1]
			];
			var bbtNum = [
				['txtMount', 10, 2, 1], ['txtWeight', 10, 3, 1], ['textSize1', 10, 3, 1],
				['textSize2', 10, 2, 1], ['textSize3', 10, 3, 1], ['textSize4', 10, 2, 1]
			];
			var bbmMask = [];
			...
			//20140523 bbs用sizea的欄位來存 工廠+加工方式 分割方法 工廠編號:工廠名稱@加工方式編號:名稱(逗號分隔);工廠編號2:工廠名稱2@加工方式編號2:名稱2(逗號分隔)
			var t_spec;
			//儲存spec陣列
			...
			<div class="dbbm">
				<table class="tbbm" id="tbbm">
					...
					<tr>
						...
						<td>
							<input id="btnApv" type="button" style="width:70%;float:right;" value="核准"/>
						</td>
		...
		<div class='dbbs'>
			<table id="tbbs" class='tbbs' style=' text-align:center'>
				<tr style='color:white; background:#003366;' >
					...
					<td align="center" style="width:180px;"></td>
				...
				<tr style='background:#cad3ff;'>
					...
					<td><input class="txt" id="txtSizea.*" type="text" style="width:95%;"/></td>
					<td><input id="btnChoice.*" type="button" style="width:95%;"/></td>
