...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			function btnPrint() {
				q_box("z_credit.aspx?;;;;" + r_accy, '', "95%", "95%", q_getMsg("popPrint"));
			}
			...
			function btnOk() {
				...
				$('#txtNoa').val(t_noa);
				var t_datea = trim(q_date());
				if (t_noa.length == 0 || t_noa == "AUTO")
					q_gtnoa(q_name, replaceAll(q_getPara('sys.key_credit') + (t_datea.length == 0 ? q_date() : t_datea), '/', ''));
				else
					wrServer(t_noa);
			}
