<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
            var q_name = 'salpresents', t_content = ' field=noa,sssno,namea,hr_special order=odate', afilter = [], bbsKey = ['noa'], as;
            var t_sqlname = 'salpresents_load';
            t_postname = q_name;
            var isBott = false;
            /// 是否已按過 最後一頁
		...
		<div  id="dbbs"  >
			<table id="tbbs"  border="2"  cellpadding='0' cellspacing='0' style='width:98%' >
				<tr>
					...
					<th align="center" style='color:Blue;' ><a id='lblHr_special'></a></th>
					<th align="center" style='color:Blue;' ><a id='lblCarryforwards'></a></th>
				</tr>
				<tr>
					<td style="width:1%;">
