...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr">
	<head>
		...
		<script type="text/javascript">
			...
			function btnPrint() {
				q_box('z_uccefep.aspx?;;;', '', "95%", "95%", q_getMsg("popPrint"));
			}
		...
		<div class='dbbs' style="width: 1260px;">
			<table id="tbbs" class='tbbs' border="1" cellpadding='2' cellspacing='1' >
				<tr style='color:White; background:#003366;' >
					...
					<td align="center" style="width:8%;"><a id='lblEmount2_s'> </a></td>
					<td align="center" style="width:8%;"><a id='lblEweight2_s'> </a></td>
					<td align="center" style="width:8%;"><a id='lblAdjmount_s'> </a></td>
				</tr>
				<tr style='background:#cad3ff;'>
					...
					<td><input class="txt num c1" id="txtAdjmount.*" type="text"/></td>
				</tr>
			</table>
		</div>
