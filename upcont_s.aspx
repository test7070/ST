	...
	<head>
		...
		<script type="text/javascript">
			...
			function q_gfPost() {
				...
				q_mask(bbmMask);
				q_cmbParse("cmbTypea", '@全部,客戶合約,廠商合約');
			...
			function q_seekStr() {
				...
				+ q_sqlPara2("cno", t_cno)+ q_sqlPara2("typea", t_typea)
				+ q_sqlPara2("custno", t_custno)+ q_sqlPara2("tggno", t_tggno)
	...
	<body>
		<div style='width:400px; text-align:center;padding:15px;' >
			<table id="seek"  border="1"   cellpadding='3' cellspacing='2' style='width:100%;' >
				...
				<tr class='seek_tr'>
					<td class='seek' style="width:30%;"><a id='lblContract'> </a></td>
