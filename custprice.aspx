...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr">
	<head>
		...
		<script type="text/javascript">
            ...
            function btnOk() {
                var t_err = '';
                t_err = q_chkEmpField([['txtNoa', q_getMsg('lblNoa')], ['txtCustno', q_getMsg('lblCustno')], ['txtAgentno', q_getMsg('lblAgentno')]]);
                if (t_err.length > 0) {
                    alert(t_err);
                    return;
                }
            ...
            function btnPrint() {
	q_box('z_custprice.aspx' + "?;;;" + trim($('#txtNoa').val()) + ";" + r_accy, '', "95%", "95%", q_getMsg("popPrint"));
