			...
			<div class='dbbm'>
				<table class="tbbm"  id="tbbm">
					...
					<tr>
						...
						<td><input id="txtDatea" type="text" class="txt c1 num" style="float: left;"/></td>
		...
		<div class='dbbs'>
			<table id="tbbs" class='tbbs'>
				<tr style='color:white; background:#003366;' >
					...
					<td align="center" style="width:5%;"><a id='lblCode1_s'></a></td>
					...
					<td align="center" style="width:15%;"><a id='lblWay1_s'></a></td>
					<td align="center" style="width:10%;"><a id='lblWeight1_s'></a></td>				
					<td align="center" style="width:5%;"><a id='lblCode2_s'></a></td>
					<td align="center" style="width:10%;"><a id='lblDetail2_s'></a></td>
					<td align="center" style="width:5%;"><a id='lblFrame2_s'></a></td>
					<td align="center" style="width:5%;"><a id='lblMount2_s'></a></td>
					<td align="center" style="width:15%;"><a id='lblWay2_s'></a></td>
					<td align="center" style="width:10%;"><a id='lblWeight2_s'></a></td>
				</tr>
				<tr  style='background:#cad3ff;'>
					...
					<td>
						<input id="txtCode1.*" type="text"  style="width : 80% ;"/>
					</td>
					...
					<td ><input id="txtWay1.*" type="text" class="txt c1"  style="width : 95% ;"/></td>
					<td ><input id="txtWeight1.*" type="text" class="num c1" style="width : 95% ;"/></td>
					<td><input id="txtCode2.*" type="text" style="width : 95% ;"/></td>
					<td><input id="txtDetail2.*" type="text" class="txt c1" style="width : 95% ;"/></td>
					<td><input id="txtFrame2.*" type="text" class="num c1" style="width : 95% ;"/></td>
					<td><input id="txtMount2.*" type="text" class="num c1" style="width : 95% ;"/></td>
					<td><input id="txtWay2.*" type="text" class="txt c1" style="width : 95% ;"/></td>
					<td><input id="txtWeight2.*" type="text" class="num c1" style="width : 95% ;"/></td>
				</tr>
			</table>
		</div>
