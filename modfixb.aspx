...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr">
	<head>
		...
		<script type="text/javascript">
            ...
            aPop = new Array(['txtBccno', 'lblBccno', 'bcc', 'noa,product', 'txtBccno,txtProduct', 'bcc_b.aspx'],
            ...
            function mainPost() {
            	q_getFormat();
				bbmMask = [['txtDatea', '999/99/99'],['txtFixadate', '999/99/99'],['txtBtime','99:99'],['txtEtime','99:99'],['txtBaddtime','99:99'],['txtEaddtime','99:99']];
				q_mask(bbmMask);
            ...
            function _btnSeek() {
            	if (q_cur > 0 && q_cur < 4)
					return;
				q_box('modfixb_s.aspx', q_name + '_s', "500px", "60%", q_getMsg("popSeek"));
            }
		...
		<div id='dmain'>
			<div class="dview" id="dview">
				<table class="tview" id="tview">
					<tr>
						...
						<td align="center" style="width:15%; color:black;"><a id='vewFixadate'> </a></td>
			...
			<div class='dbbm'>
				<table class="tbbm"  id="tbbm">
					...
					<tr>
						<td><span> </span><a id="lblBccno" class="lbl btn"> </a></td>
						<td colspan="3">
							<input id="txtBccno"  type="text" style="width:25%;"/>
							<input id="txtProduct"  type="text" style="width:75%;"/>
						</td>
						<td><span> </span><a id="lblRetired" class="lbl"> </a></td>						
						<td><input id="chkRetired" type="checkbox"/></td>
