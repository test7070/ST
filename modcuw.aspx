	...
	<head>
		...
		<script type="text/javascript">
			...
			aPop = new Array(
				...
				['txtStation','lblMech','modeq','namea','txtStation','modeq_b2.aspx']
			);
			...
			function bbtAssign() {
				for (var i = 0; i < q_bbtCount; i++) {
					$('#lblNo__' + i).text(i + 1);
					if(WorkTimeList.length > 0){
						q_cmbParse("combWorktime__"+i, WorkTimeList);
					}
		...
		<div id='dmain'>
			<div class="dview" id="dview" >
				<table class="tview" id="tview" >
					<tr>
						...
						<td style="width:120px; color:black;"><a id='vewMech'> </a></td>
					</tr>
					<tr>
			...
			<div class='dbbm'>
				<table class="tbbm" id="tbbm">
					...
					<tr>
						<td style =" display :none"><span> </span><a id="lblStationno" class="lbl btn"> </a></td>
						<td style =" display :none"><input id="txtStationno" type="text" class="txt c1"/></td>
						<td><span> </span><a id="lblMech" class="lbl btn"> </a></td>
						<td><input id="txtStation" type="text" class="txt c1"/></td>
						<td style =" display :none" colspan="2" style="text-align:left;">
