        ...
        <script type="text/javascript">
				...
				$('.lblDownload').each(function(){
					...
					$('#'+lblfiles).click(function(e) {
                        if(txtfiles.length>0)
                        	$('#xdownload').attr('src','upmeet_download.aspx?FileName='+$('#'+txtOrgName[0]+'name_'+txtOrgName[1]).val()+'&TempName='+$('#'+txtfiles).val());
                        else
                        	alert('無資料...!!');
					});
				});
            ...
            function _btnSeek() {
                if (q_cur > 0 && q_cur < 4)// 1-3
                    return;
                q_box('upmeet_s.aspx', q_name + '_s', "500px", "320px", q_getMsg("popSeek"));
            }
		        ...
		        $('.btnFiles').change(function() {
					...
					if(file){
						...
						fr.onloadend = function(e){
							...
							oReq.open("POST", 'upmeet_upload.aspx', true);
			...
			<div class="dview" id="dview" style="float: left; "  >
				<table class="tview" id="tview"   border="1" cellpadding='2'  cellspacing='0' style="background-color: #FFFF66;">
					<tr>
						...
						<td align="center" style="width:15%"><a id='vewAcomp'> </a></td>
