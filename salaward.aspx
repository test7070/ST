...
<head>
	...
	<script type="text/javascript">
		...
		var bbsNum = [['txtTotal1',10,0,1],['txtTotal2',10,0,1],['txtTotal3',10,0,1],['txtTotal4',10,0,1],['txtTotal5',10,0,1],['txtMoney',15,0,1],['txtTaxrate',5,2,1],['txtTax',10,0,1],['txtTotal6',10,0,1],['txtTotal7',10,0,1],['txtTotal8',14,0,1],['txtSecondmoney',14,0,1]];
		var bbmMask = [];
		var bbsMask = [];
		...
		function _btnSeek() {
			...
			q_box('salaward_s.aspx', q_name + '_s', "500px", "320px", q_getMsg("popSeek"));
		}
		...
		function btnPrint() {
			q_box('z_salaward.aspx' + "?;;;noa="+$('#txtNoa').val()+";" + r_accy, '','95%', '95%', q_getMsg("popPrint"));
		}
		...
		function sum() {//只計算每個獎金金額合計(人工調整獎金用)
			...
			for (var j = 0; j < q_bbsCount; j++) {
				...
				q_tr('txtTotal7_'+j,q_float('txtTax_'+j)+q_float('txtTotal6_'+j)+q_float('txtSecondmoney_'+j));
...
<!--#include file="../inc/toolbar.inc"-->
		...
		<table id="tbbs" class='tbbs'  border="1"  cellpadding='2' cellspacing='1' style="width: 1886px;background:#cad3ff;" >
			<tr style='color:White; background:#003366;' >
				...
				<td align="center" style="width:100px;"><a id='lblHelthSecondmoney_s'> </a></td>
