	...
	<head>
		...
		<script type="text/javascript">
			...
			function mainPost() {
				...
				q_mask(bbmMask);
				bbmNum = [['txtMoney', 15, 0, 1], ['txtTax', 10, 0, 1], ['txtTotal', 15, 0, 1],['txtPrice', 10, q_getPara('rc2.pricePrecision'), 1],['txtTranmoney',15,0,1],['txtMount',15,0,1],['txtDiscount',15,0,1]];
		...
		<div class='dbbs' style="width: 1260px;">
			<table id="tbbs" class='tbbs' border="1" cellpadding='2' cellspacing='1' >
				<tr style='color:White; background:#003366;' >
					...
					<td align="center" style="width:120px;"><a id='lblAcc1s'> </a><br><a id='lblAcc2s'> </a></td>
