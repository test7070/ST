...
<head>
    ...
    <script language="c#" runat="server">
        public void Page_Load()
        {
            ...
            Response.Write("<a style='margin-right: 10px;'>圖片1</a><span></span><input type=\"file\" name=\"btnFile1\" style='font-size: medium;'/><P>");
            Response.Write("<a style='margin-right: 10px;'>圖片2</a><span></span><input type=\"file\" name=\"btnFile2\" style='font-size: medium;'/><P>");
            Response.Write("<a style='margin-right: 10px;'>圖片3</a><span></span><input type=\"file\" name=\"btnFile3\" style='font-size: medium;'/><P>");
            Response.Write("<a style='margin-right: 10px;'>圖片4</a><span></span><input type=\"file\" name=\"btnFile4\" style='font-size: medium;'/><P>");
            Response.Write("<a style='margin-right: 10px;'>圖片5</a><span></span><input type=\"file\" name=\"btnFile5\" style='font-size: medium;'/><P>");
            Response.Write("<a style='margin-right: 10px;'>圖片6</a><span></span><input type=\"file\" name=\"btnFile6\" style='font-size: medium;'/><P><BR>");
