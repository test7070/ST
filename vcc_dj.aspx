	...
	<head>
		...
		<script type="text/javascript">
			...
			var bbsNum = [
				...
				['textSize4', 10, 2, 1],['txtTranmoney2', 15, 2, 1]
			];
			var bbmMask = [];
		...
		<div class='dbbs'>
			<table id="tbbs" class='tbbs' style=' text-align:center'>
				<tr style='color:white; background:#003366;' >
					...
					<td align="center" style="width:150px;"><a id='lblAcc_dj'>表色/底色</a></td>
					<td align="center" style="width:80px;"><a id='lblTranmoney2_dj'>皮膜厚</a></td>
				...
				<tr style='background:#cad3ff;'>
					...
					<td>
						<input id="txtAcc1.*" type="text" class="txt" style="width:95%;"/>
						<input id="txtAcc2.*" type="text" class="txt" style="width:95%;"/>
					</td>
