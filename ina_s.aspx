	...
	<head>
		...
		<script type="text/javascript">
            ...
            function q_seekStr() {
                ...
                var t_where = " 1=1 " + q_sqlPara2("noa", t_noa) + q_sqlPara2("datea", t_bdate, t_edate) + q_sqlPara2("tggno", t_tggno) + q_sqlPara2("comp", t_comp) + q_sqlPara2("storeno", t_storeno) + q_sqlPara2("store", t_store);
