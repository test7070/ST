<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			var q_name = 'view_ordbs', t_bbsTag = 'tbbs', t_content = " field=productno,product,spec,dime,width,lengthb,radius,mount,weight,noa,no3,price,total,theory,memo,kind,style,class,uno,size,unit,source order=odate ", afilter = [], bbsKey = ['noa', 'no3'], t_count = 0, as;//,acoin,afloata,amemo
