<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
            var q_name = 'cardeals', t_content = ' field=carno,noa,comp,nick', bbsKey = ['noa'], as, t_where = '';
            var isBott = false;
            /// 是否已按過 最後一頁
	...
	<body>
		<div  id="dbbs"  >
			<table id="tbbs"  border="2"  cellpadding='0' cellspacing='0' style='width:98%' >
				<tr>
					<th align="center" ></th>
					<th align="center" style='color:Blue;' ><a id='lblCarno'></a></th>
					<th align="center" style='color:Blue;' ><a id='lblNoa'></a></th>
					<th align="center" style='color:Blue;' ><a id='lblComp'></a></th>
				</tr>
				<tr>
					<td style="width:2%;"><input name="sel"  id="radSel.*" type="radio" /></td>
					<td style="width:20%;"><input class="txt" id="txtCarno.*" type="text" style="width:98%;"  readonly="readonly" /></td>
