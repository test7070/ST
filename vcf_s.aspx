	...
	<head>
		...
		<script type="text/javascript">
			...
			aPop = new Array(['txtTggno', 'lblTggno', 'tgg', 'noa,comp', 'txtTggno', 'tgg_b.aspx']
				,['txtIproductno', 'lblIproductno', 'ucc', 'noa,product', 'lblIproductno', "ucc_b.aspx?" ]
				,['txtOproductno', 'lblOproductno', 'ucc', 'noa,product', 'lblOproductno', "ucc_b.aspx?" ]);
            ...
            function q_seekStr() {
		        ...
		        t_iproductno = $.trim($('#txtIproductno').val());
		        t_oproductno = $.trim($('#txtOproductno').val());
		        ...
		        if (t_tgg.length>0)
		       	...
		       	if(t_iproductno.length>0)
		       		t_where += " and exists(select noa from vcft where vcft.noa=vcf.noa and vcft.productno='"+t_iproductno+"')";
	       		if(t_oproductno.length>0)
		       		t_where += " and exists(select noa from vcfs where vcfs.noa=vcf.noa and vcfs.productno='"+t_oproductno+"')";
	...
	>
		<div style='width:400px; text-align:center;padding:15px;' >
			<table id="seek"  border="1"   cellpadding='3' cellspacing='2' style='width:100%;' >
				...
				<tr class='seek_tr'>
					<td class='seek'  style="width:20%;"><a id='lblIproductno'></a></td>
					<td>
					<input class="txt" id="txtIproductno" type="text" style="width:215px; font-size:medium;" />
					</td>
				</tr>
				<tr class='seek_tr'>
					<td class='seek'  style="width:20%;"><a id='lblOproductno'></a></td>
					<td>
					<input class="txt" id="txtOproductno" type="text" style="width:215px; font-size:medium;" />
					</td>
				</tr>
			</table>
