	...
	<head>
		...
		<script type="text/javascript">
			...
			function q_seekStr() {
				...
				t_mon = $('#txtMon').val();
				t_trdno = $('#txtTrdno').val();
				
				
				var t_where = " 1=1 " + q_sqlPara2("cno", t_cno)+ q_sqlPara2("mon", t_mon)+ q_sqlPara2("noa", t_noa)+ q_sqlPara2("serial", t_serial) 
				+ q_sqlPara2("custno", t_custno) + q_sqlPara2("datea", t_bdate, t_edate)+ q_sqlPara2("trdno", t_trdno)  ;
				if (t_cust.length > 0)
		...
		<div style='width:400px; text-align:center;padding:15px;' >
			<table id="seek"  border="1"   cellpadding='3' cellspacing='2' style='width:100%;' >
				...
				<tr class='seek_tr'>
					...
					<td><input class="txt" id="txtBuyer" type="text" style="width:215px; font-size:medium;" /></td>
				</tr>
				<tr class='seek_tr'>
