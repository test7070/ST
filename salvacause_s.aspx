...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
            ...
            var aPop = new Array(['txtSssno', '', 'sss', 'noa,namea', 'txtSssno,txtNamea', 'sss_b.aspx'], ['txtHtype', '', 'salhtype', 'noa,namea', 'txtHtype,txtHname', 'salhtype_b.aspx']);
            ...
            function q_seekStr() {
                ...
                t_bhdate = t_bhdate.length > 0 && t_bhdate.indexOf("_") > -1 ? t_bhdate.substr(0, t_bhdate.indexOf("_")) : t_bhdate;
                /// 100.  .
                t_ehdate = t_ehdate.length > 0 && t_ehdate.indexOf("_") > -1 ? t_ehdate.substr(0, t_ehdate.indexOf("_")) : t_ehdate;
                /// 100.  .

                var t_where = " 1=1 " + q_sqlPara2("noa", t_noa) + q_sqlPara2("datea", t_bdate, t_edate) + q_sqlPara2("sssno", t_sssno) + q_sqlPara2("namea", t_namea) + q_sqlPara2("htype", t_htype) + q_sqlPara2("hname", t_hname) + q_sqlPara2("bdate", t_bhdate, t_ehdate) + q_sqlPara2("edate", t_bhdate, t_ehdate);
		...
		<div style='width:400px; text-align:center;padding:15px;' >
			<table id="seek"  border="1"   cellpadding='3' cellspacing='2' style='width:100%;' >
				...
				<tr class='seek_tr'>
					...
					<td>
					<input class="txt" id="txtHtype" type="text" style="width:90px; font-size:medium;" />
					&nbsp;
					<input class="txt" id="txtHname" type="text" style="width:115px; font-size:medium;" />
					</td>
				</tr>
			</table>
