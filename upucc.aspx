...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr">
    <head>
        ...
        <script type="text/javascript">
            ...
            q_desc = 1;
            aPop = new Array(['txtProductno', 'lblCust', 'ucaucc', 'noa,product', '0txtProductno,txtProduct', 'ucaucc_b.aspx']);
				...
				$('.lblDownload').each(function(){
					...
					$('#'+lblfiles).click(function(e) {
                        if(txtfiles.length>0)
                        	$('#xdownload').attr('src','upucc_download.aspx?FileName='+$('#'+txtOrgName[0]+'name_'+txtOrgName[1]).val()+'&TempName='+$('#'+txtfiles).val());
                        else
                        	alert('無資料...!!');
					});
				});
            ...
            function _btnSeek() {
                if (q_cur > 0 && q_cur < 4)// 1-3
                    return;
                q_box('upucc_s.aspx', q_name + '_s', "500px", "320px", q_getMsg("popSeek"));
            }
		        ...
		        $('.btnFiles').change(function() {
					...
					if(file){
						...
						fr.onloadend = function(e){
							...
							oReq.open("POST", 'upucc_upload.aspx', true);
			...
			<div class='dbbm' style="float: left;">
				<table class="tbbm"  id="tbbm"   border="0" cellpadding='2'  cellspacing='5'>
					...
					<tr>
						...
						<td colspan="3">
							<input id="txtProductno"  type="text"  class="txt c1" style="width: 130px;"/>
							<input id="txtProduct"  type="text"  class="txt c1" style="width: 400px;"/>
						</td>
					</tr>
					<tr>
