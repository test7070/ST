		...
		<script type="text/javascript">
            ...
            function mainPost() {
                ...
                $('#txtNoa').change(function(e) {			
					...
					q_gt('logo', t_where, 0, 0, 0, "checkNoa_change", r_accy);				
				});
            ...
            function q_gtPost(t_name) {
                switch (t_name) {
                	case 'checkNoa_change':
						var as = _q_appendData("logo", "", true);
						if (as[0] != undefined) {
							alert('已存在 ' + as[0].noa);
							Unlock(1);
							return;
            ...
            function _btnSeek() {
                if (q_cur > 0 && q_cur < 4)// 1-3
                    return;
                q_box('logo_s.aspx', q_name + '_s', "500px", "310px", q_getMsg("popSeek"));
            }
            ...
            function btnOk() {
				...
				if (q_cur == 1) {
					...
					q_gt('logo', t_where, 0, 0, 0, "checkNoa_btnOk");
				} else {
					wrServer($('#txtNoa').val());
				}          	
            }
				...
				<table class="tbbm"  id="tbbm">
					<tbody>
						...
						<tr>
							...
							<td colspan="2"><textarea id="txtMemo" rows="5" class="txt c1"></textarea></td>
						</tr>
						<tr>
