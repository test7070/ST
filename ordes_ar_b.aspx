		...
		<div  id="dFixedTitle" style="overflow-y: scroll;">
			<table id="tFixedTitle" class='tFixedTitle'  border="2"  cellpadding='2' cellspacing='1' style='width:100%'  >
				<tr style='color:White; background:#003366;' >
					...
					<td align="center" style="width:12%;"><a id='lblSpec'> </a></td>
					<td align="center" style="width:12%;"><a id='lblSize'> </a></td>
		...
		<div  id="dbbs" style="overflow: scroll;height:550px;" >
			<table id="tbbs" class='tbbs'  border="2"  cellpadding='2' cellspacing='1' style='width:100%'  >
				<tr style='color:White; background:#003366;display:none;' >
					...
					<td align="center" style="width:10%;"><a id='lblSize'> </a></td>
				...
				<tr  style='background:#cad3ff;'>
					...
					<td style="width:3%;"><a id="lblNo.*" style="font-weight: bold;text-align: center;display: block;"> </a></td>
					<td style="width:12%;">
						<input class="txt"  id="txtProductno.*" type="text" style="width:98%;" />
						<input class="txt" id="txtProduct.*" type="text" style="width:98%;" />
					</td>
					<td style="width:12%;"><input class="txt" id="txtSpec.*" type="text"  style="width:94%;text-align:center;" /></td>
					<td style="width:12%;"><input class="txt" id="txtSize.*" type="text"  style="width:98%;" /></td>
