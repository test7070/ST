            ...
            <div class="dview" id="dview">
                <table class="tview" id="tview">
                    <tr>
                        ...
                        <td align="center" style="width:80px; color:black; "><a id='vewWorker'> </a></td>
                    </tr>
                    <tr>
                        <td>
            ...
            <div class='dbbm'>
                <table class="tbbm"  id="tbbm">
                    ...
                    <!--<tr style="display :none;">
                    	...
                    	<td style="display :none;"><span> </span><a id="lblManu" class="lbl" > </a></td>
                        <td style="display :none;" colspan="2"><input id="txtManu"type="text" class="txt c1"/></td>
                    </tr>
                    <tr style="display :none;">
                    	<td style="display :none;"><span> </span><a id="lblTel" class="lbl" > </a></td>
                        <td style="display :none;" colspan="2"><input id="txtTel"type="text" class="txt c1"/></td>
                    	<td style="display :none;"><span> </span><a id="lblFax" class="lbl" > </a></td>
                        <td style="display :none;" colspan="2"><input id="txtFax"type="text" class="txt c1"/></td>
                    </tr>
                    <tr style="display :none;">
                    	<td style="display :none;"><span> </span><a id='lblTax' class="lbl"> </a></td>
                        <td style="display :none;"><input id="txtTax" type="text" class="txt c1 num" /></td>
                        <td style="display :none;"><select id="cmbTaxtype" class="txt c1" > </select></td>
                    </tr>
                    <tr style="display :none;">
                    	<td style="display :none;"><span> </span><a id='lblMoney' class="lbl"> </a></td>
                        <td style="display :none;"><input id="txtMoney" type="text" class="txt c1 num" /></td>
                        <td style="display :none;"><span> </span><a id='lblTotal' class="lbl"> </a></td>
                        <td style="display :none;"><input id="txtTotal" type="text" class="txt c1 num" /></td>
                    </tr>
                    <tr style="display :none;">
                    	<td style="display :none;"><span> </span><a id='lblImount' class="lbl"> </a></td>
                        <td style="display :none;"><input id="txtImount" type="text" class="txt c1 num" /></td>
                        <td style="display :none;"><span> </span><a id='lblIweight' class="lbl"> </a></td>
                        <td style="display :none;"><input id="txtIweight" type="text" class="txt c1 num" /></td>
                    </tr>
                    <tr style="display :none;">
                    	<td style="display :none;"><span> </span><a id='lblOmount' class="lbl"> </a></td>
