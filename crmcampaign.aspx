    ...
    <script type="text/javascript">
       ...
       function main() {
        ...
        function btnIns() {
            ...
            refreshBbm();
            $('#txtNoa').focus();
            $('#txtAdbdatea').val(q_date());
            $('#txtAdedatea').val(q_date());
...
<!--#include file="../inc/toolbar.inc"-->
        ...
        <table class="tbbm"  id="tbbm">
            ...
            <tr>
			   <td><span> </span><a id='lblAdbdatea' class="lbl"></a></td>
               <td><input id="txtAdbdatea"  type="text" class="txt c1"  /></td>
               <td><span> </span><a id='lblAdedatea' class="lbl"></a></td>
               <td><input id="txtAdedatea"  type="text" class="txt c1"  /></td>
            </tr>
            <tr>
			   <td><span> </span><a id='lblBdatea' class="lbl"></a></td>
               <td><input id="txtBdatea"  type="text" class="txt c1"  /></td>
