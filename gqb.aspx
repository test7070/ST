	...
	<head>
		...
		<script type="text/javascript">
            ...
            function mainPost() {
                ...
                $('#lblBkaccno').click(function() {
                    q_pop('txtBkaccno', "accc.aspx?" + r_userno + ";" + r_name + ";" + q_time + ";accc3='" + $('#txtBkaccno').val() + "';" + r_accy + '_' + r_cno, 'accc', 'accc3', 'accc2', "95%", "95%", q_getMsg('popAccc'), true);
                });
			...
			<div class='dbbm'>
				<table class="tbbm"  id="tbbm">
					...
					<tr>
						...
						<td><span> </span><a id='lblBkaccno' class="lbl btn"> </a></td>
					...
					<tr>
						...
						<td><input id="txtWorker"  type="text" class="txt c2" />
							<span> </span><a id='lblWorker2' class="lbl"> </a></td>
