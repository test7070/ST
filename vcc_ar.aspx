...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr">
	<head>
		...
		<script type="text/javascript">
			...
			q_tables = 's';
			var q_name = "vcc";
			var q_readonly = ['txtVccatax', 'txtComp', 'txtAccno', 'txtAcomp', 'txtSales', 'txtNoa', 'txtWorker', 'txtWorker2', 'txtMoney', 'txtWeight', 'txtTotal', 'txtTax'];
			var q_readonlys = ['txtTotal', 'txtOrdeno', 'txtNo2', 'txtTheory','txtDime','txtWidth','txtRadius','txtLengthb'];
			var bbmNum = [
				...
				switch (b_pop) {
					case 'view_vcce_import':
						if (q_cur > 0 && q_cur < 4) {
							...
							AddRet = q_gridAddRow(bbsHtm, 'tbbs', 'txtUno,txtOrdeno,txtNo2,txtProductno,txtProduct,txtUnit,txtRadius,txtWidth,txtDime,txtLengthb,txtSpec,txtMount,txtWeight,txtPrice,txtStyle,txtSize', b_ret.length, b_ret, 'uno,ordeno,no2,productno,product,unit,radius,width,dime,lengthb,spec,mount,weight,price,style,size', '');
			...
			<div class="dbbm">
				<table class="tbbm" id="tbbm">
					...
					<tr>
						...
						<td> </td>
						<td>
							<input type="button" id="btnTip" value="?"  onclick="tipShow()"/>
						</td>
					</tr>
					<tr>
		...
		<div class='dbbs'>
			<table id="tbbs" class='tbbs' style=' text-align:center'>
				<tr style='color:white; background:#003366;' >
					...
					<td align="center" style="width:150px;"><a id='lblProduct'> </a><BR><a id='lblSize_st'> </a></td>
				...
				<tr style='background:#cad3ff;'>
					...
					<td>
						...
						<input id="txtProductno.*" type="text" style="width:120px;" />
					</td>
					<td><input type="text" id="txtStyle.*" style="width:85%;text-align:center;" /></td>
					<td>
						<input id="txtProduct.*" type="text" style="float:left;"/>
