...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			var q_name = "upucc_s";
			aPop = new Array(['txtProductno', 'lblProductno', 'ucaucc', 'noa,product', '0txtProductno', 'ucaucct_b.aspx']);
			...
			function q_seekStr() {
				...
				var t_where = " 1=1 " + q_sqlPara2("datea", t_bdate, t_edate)+ q_sqlPara2("productno", t_productno);
