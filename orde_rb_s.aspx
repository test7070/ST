	...
	<head>
		...
		<script type="text/javascript">
            ...
            function q_gfPost() {
                ...
                q_mask(bbmMask);
                q_cmbParse("cmbVcctype", '@全部,1@已出貨,2@未出貨');
            ...
            function q_seekStr() {///  搜尋按下時，執行
                ...
                var t_where = " 1=1 " + q_sqlPara2("odate", t_bdate, t_edate) + q_sqlPara2("noa", t_noa) + q_sqlPara2("salesno", t_salesno) + q_sqlPara2("custno", t_custno) + q_sqlPara2("vccno", t_vccno);
				//+ q_sqlPara2("nick", t_comp)
	...
	<body>
		<div style='width:400px; text-align:center;padding:15px;' >
			<table id="seek"  border="1"   cellpadding='3' cellspacing='2' style='width:100%;' >
				...
				<tr class='seek_tr'>
					<td class='seek'  style="width:20%;"><a>出貨狀況</a></td>
					<td><select id="cmbVcctype" class="txt c1" style="font-size:medium;"> </select></td>
				</tr>
				<tr class='seek_tr'>
