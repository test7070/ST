...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr">
	<head>
		...
		<script type="text/javascript">
			...
			var q_name = "rc2a";
			var q_readonly = ['txtTotal', 'txtChkno', 'txtTax', 'txtAccno', 'txtWorker'];//'txtMoney'
			...
			,['txtTggno', 'lblTgg', 'tgg', 'noa,comp,nick,serial', '0txtTggno,txtComp,txtNick,txtSerial', 'tgg_b.aspx']
			...
			function _btnSeek() {
				...
				q_box('rc2a_s.aspx', q_name + '_s', "550px", "450px", q_getMsg("popSeek"));
			}
