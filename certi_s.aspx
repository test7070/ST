        ...
        <script type="text/javascript">
			...
			function q_seekStr() {
				...
				var t_where = " 1=1 " 
				    ...
				    + q_sqlPara2("lcno", t_lcno); 
				    
				if (t_cust.length > 0)
					t_where += " and charindex('" + t_cust + "',cust)>0";
				if (t_uno.length > 0)
					t_where += " and exists(select noa from certis where certis.noa=certi.noa and certis.uno='" + t_uno + "')";
        ...
        <div style='width:400px; text-align:center;padding:15px;' >
            <table id="seek"  border="1"   cellpadding='3' cellspacing='2' style='width:100%;' >
                ...
                <tr class='seek_tr'>
                    ...
                    <td>
                    <input class="txt" id="txtOrdeno" type="text" style="width:90px; font-size:medium;" />
                    </td>
                </tr>
                <tr class='seek_tr'>
                    <td class='seek'  style="width:20%;"><a id='lblLcno'></a></td>
                    <td>
                    <input class="txt" id="txtLcno" type="text" style="width:215px; font-size:medium;" />
                    </td>
                </tr>
                <tr class='seek_tr'>
