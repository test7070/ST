	...
	<body>
		<div style='width:400px; text-align:center;padding:15px;' >
			<table id="seek"  border="1" cellpadding='3' cellspacing='2' style='width:100%;' >
				...
				<tr class='seek_tr'>
					<td style="width:35%;" ><a id='lblDatea'>核價日</a></td>
					<td style="width:65%;">
				...
				<tr class='seek_tr'>
					...
					<td>
						<input class="txt" id="txtTggno" type="text" style="width:200px; font-size:medium;" />&nbsp;
					</td>
				</tr>
				<tr class='seek_tr'>
					<td class='seek' style="width:20%;"><a id='lblTgg'>廠商名稱</a></td>
					<td>
						<input class="txt" id="txtTgg" type="text" style="width:200px; font-size:medium;" />&nbsp;
					</td>
				</tr>
				<tr class='seek_tr'>
