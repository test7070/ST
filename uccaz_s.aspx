	...
	<body>
		<div style='width:400px; text-align:center;padding:15px;' >
			<table id="seek"  border="1"   cellpadding='3' cellspacing='2' style='width:100%;' >
				<tr class='seek_tr'>
					<td class='seek'  style="width:20%;"><a id='lblNoa'>產品編號</a></td>
					<td>
				...
				<tr class='seek_tr'>
                    <td class='seek'  style="width:20%;"><a id='lblType'>性質</a></td>
                    <td>
                    <select id="cmbTypea" class="txt" style="width:215px;"> </select>
                    </td>
                </tr>
                <tr class='seek_tr'>
                    <td class='seek'  style="width:20%;"><a id='lblUnit'>單位</a></td>
                    <td>
