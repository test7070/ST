	...
	<head>
		...
		<script type="text/javascript">
            ...
            function q_seekStr() {///  搜尋按下時，執行
                ...
                if(t_carno.length>0){
                	t_where=t_where+" and noa in (select noa from cardeals where carno='"+t_carno+"')"
                }
	...
	<body>
		<div style='width:400px; text-align:center;padding:15px;' >
			<table id="seek"  border="1"   cellpadding='3' cellspacing='2' style='width:100%;' >
				...
				<tr class='seek_tr'>
					<td   style="width:35%;" ><a id='lblCarno'> </a></td>
					<td style="width:65%;  "><input class="txt" id="txtCarno" type="text" style="width:215px; font-size:medium;" /></td>
				</tr>
			</table>
