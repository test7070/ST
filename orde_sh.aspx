...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr">
	<head>
		...
		<script type="text/javascript">
			...
			q_tables = 's';
			var q_name = "orde";
			var q_readonly = ['txtNoa', 'txtWorker', 'txtWorker2', 'txtComp', 'txtAcomp', 'txtMoney', 'txtTax', 'txtTotal', 'txtSales'];
			...
			aPop = new Array(
				['txtProductno_', 'btnProduct_', 'ucaucc2', 'noa,product,unit,spec', 'txtProductno_,txtProduct_,txtUnit_,txtSpec_,txtMount_', 'ucaucc_b.aspx'],
			...
			function btnPrint() {
                ...
                q_box("z_ordep_sh.aspx?" + r_userno + ";" + r_name + ";" + q_time + ";" + t_where, '', "95%", "95%", q_getMsg('popPrint'));
			}
		...
		<div class='dbbs' style="width: 1350px;">
			<table id="tbbs" class='tbbs' border="1" cellpadding='2' cellspacing='1'>
				...
				<tr style='background:#cad3ff;'>
					...
					<td align="center"><input id="txtNo2.*" type="text" class="txt c1"/></td>
					<td align="center">
						<input class="txt c6" id="txtProductno.*" maxlength='30'type="text" style="width:70%;" />
