		...
		<script type="text/javascript">
            ...
            function mainPost() {
                ...
                $('#btnIndata').click(function() {
                    if (!emp($('#txtNoa').val())) {
                    	//找去年移至下年度的特休
                    	var t_where = "where=^^ noa='"+(dec($('#txtNoa').val())-1)+"' ^^ stop=1";
            ...
            function q_gtPost(t_name) {
                switch (t_name) {
                	case 'salvaca_indata':
                		...
                		var t_where = "where=^^ isnull(outdate,'')='' ^^";
            ...
            function btnIns() {
                _btnIns();
                if(q_date().substr(r_len+1, 2)>='07')
                	$('#txtNoa').val(q_cdn(q_date().substr(0, r_len)+'/01/01',366).substr(0, r_len));
                else
		...
		<div class='dbbs' style="width: 1700px;">
			<table id="tbbs" class='tbbs'  border="1"  cellpadding='2' cellspacing='1' >
				<tr style='color:White; background:#003366;' >
					...
					<td align="center" class="td1" style="width: 100px;"><a id='lblPrevyeartime'> </a></td>
					<td align="center" class="td1" style="width: 90px;"><a id='lblLimitday'> </a></td>
					<td align="center" class="td1" style="width: 100px;"><a id='lblNextyeartime'> </a></td>
				...
				<tr  style='background:#cad3ff;'>
					...
					<td ><input class="txt num c1" id="txtPrevyeartime.*" type="text"/></td>
					<td ><input class="txt num c1" id="txtLimitday.*" type="text"/></td>
					<td ><input class="txt num c1" id="txtNextyeartime.*" type="text"/></td>
