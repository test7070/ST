    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function mainPost() {
            	bbmMask = [];
                q_mask(bbmMask);
                q_cmbParse("cmbTypea", q_getPara('upcust.typea'));
            }
            ...
            function _btnSeek() {
                if (q_cur > 0 && q_cur < 4)// 1-3
                    return;
                q_box('upcust_s.aspx', q_name + '_s', "500px", "320px", q_getMsg("popSeek"));
            }
            ...
            function btnOk() {
                Lock(1,{opacity:0});
            	var t_err = '';
                t_err = q_chkEmpField([['txtMemo', q_getMsg('lblMemo')],['txtFiles', q_getMsg('lblFiles')],['txtCustno', q_getMsg('lblCust')],['txtComp', q_getMsg('lblCust')]]);
			...
			<div class="dview" id="dview" style="float: left; "  >
				<table class="tview" id="tview"   border="1" cellpadding='2'  cellspacing='0' style="background-color: #FFFF66;">
					<tr>
						...
						<td align="center" style="width:15%"><a id='vewCust'> </a></td>
